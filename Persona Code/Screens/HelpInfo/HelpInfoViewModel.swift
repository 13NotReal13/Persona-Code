...
final class HelpInfoViewModel {
    let categories: [EnergyInfo] = [
        EnergyInfo(energyNumber: 0, title: "1. Число Судьбы", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "2. Жизненный Путь", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "3. Отношения", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "4. Деньги и Финансы", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "5. Карьера и Профессия", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "6. Здоровье", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "7. Таланты и Способности", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "8. Испытания и Препятствия", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "9. Личностный Рост", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "10. Внутренний Мир", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "11. Предназначение", subcategories: [
        ...
        EnergyInfo(energyNumber: 0, title: "12. Кармические Уроки", subcategories: [
